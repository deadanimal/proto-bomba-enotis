    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-6">
                        <a href="/status-notis" class="btn btn-default w-100" type="button">Siap</a>
                    </div>
                    <div class="col-6">
                        <a href="/status-notis-dihantar" class="btn btn-info w-100" type="button">Dihantar</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a href="/status-notis-edit" class="btn btn-icon btn-success btn-sm" type="button">
