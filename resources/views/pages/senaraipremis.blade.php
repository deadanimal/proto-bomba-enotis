        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="/tambah-premis" class="btn btn-icon btn-2 btn-default" type="button">
                    ...
                    <li class="mb-2">
                        <a href="/maklumat-premis">
                            <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm">AMAN BAKTI SDN BHD</h6>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="/maklumat-premis">
                            <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm">AKAL BUDI RESOURCES</h6>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li class="mb-2">
                        <a href="/maklumat-premis">
                            <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm">COWAY (M) SDN BHD</h6>
                                </div>
                            </div>
                        </a>
                    </li>
